...
@Component
public class OnChainManagerImpl implements OnChainManager {
    ...
    public OnChainManagerImpl(@Value("${starcoin.sender-address}") String senderAddressHex,
...
//        }
    ...
    private boolean isDataSourceInitialized(PriceOracleType priceOracleType) {
    ...
    private BigInteger getSenderSequenceNumber(String address) {
