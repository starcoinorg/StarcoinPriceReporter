// cp ../../../../../../starcoinorg/starcoin/vm/stdlib/modules/Oracle.move .
...
module PriceOracle {
    use 0x1::Math;
    use 0x07fa08a855753f0ff7292fdcbe871216::Oracle::{Self, DataRecord, UpdateOracleCapability};
...
module PriceOracleAggregator {
    use 0x1::Vector;
    use 0x07fa08a855753f0ff7292fdcbe871216::Oracle;
    use 0x07fa08a855753f0ff7292fdcbe871216::PriceOracle;
    use 0x1::Math;
    use 0x1::Timestamp;
    use 0x1::Errors;
